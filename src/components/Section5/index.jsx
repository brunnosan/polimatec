        ...
        <div className="mx-8 py-5">
          ...
          {/* <div className="grid"> */}
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', minWidth: '21rem', minHeight: '14rem'}}>
              <img src={imgSection5_1} className="w-27rem h-18rem sm:w-21rem sm:h-14rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', minWidth: '21rem', minHeight: '14rem'}}>
              <img src={imgSection5_2} className="w-27rem h-18rem sm:w-21rem sm:h-14rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', minWidth: '21rem', minHeight: '14rem'}}>
              <img src={imgSection5_3} className="w-27rem h-18rem sm:w-21rem sm:h-14rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', minWidth: '21rem', minHeight: '14rem'}}>
              <img src={imgSection5_4} className="w-27rem h-18rem sm:w-21rem sm:h-14rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', minWidth: '21rem', minHeight: '14rem'}}>
              <img src={imgSection5_5} className="w-27rem h-18rem sm:w-21rem sm:h-14rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', minWidth: '21rem', minHeight: '14rem'}}>
              <img src={imgSection5_6} className="w-27rem h-18rem sm:w-21rem sm:h-14rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
          </div>
        </div>
      </section>

    ...
    <>
      <section className="relative" style={{backgroundColor: 'rgb(4, 5, 36)',}}>
        <div className="mx-8 py-5">
          ...
          {/* <div className="grid"> */}
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', width: 'calc(33.333333% - (2rem * 2) / 3)', minWidth: '16rem', minHeight: '16rem'}}>
              <img src={imgSection5_1} className="h-20rem" style={{objectFit: 'cover', objectPosition: 'center'}} alt="" />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', width: 'calc(33.333333% - (2rem * 2) / 3)', minWidth: '16rem', minHeight: '16rem'}}>
              <img src={imgSection5_2} className="h-20rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', width: 'calc(33.333333% - (2rem * 2) / 3)', minWidth: '16rem', minHeight: '16rem'}}>
              <img src={imgSection5_3} className="h-20rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', width: 'calc(33.333333% - (2rem * 2) / 3)', minWidth: '16rem', minHeight: '16rem'}}>
              <img src={imgSection5_4} className="h-20rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', width: 'calc(33.333333% - (2rem * 2) / 3)', minWidth: '16rem', minHeight: '16rem'}}>
              <img src={imgSection5_5} className="h-20rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
            <div className='col-4 flex flex-column' style={{flex: '0 0 calc(33.333333% - (2rem * 2) / 3)', width: 'calc(33.333333% - (2rem * 2) / 3)', minWidth: '16rem', minHeight: '16rem'}}>
              <img src={imgSection5_6} className="h-20rem" style={{objectFit: 'cover', objectPosition: 'center'}} />
            </div>
          </div>
        </div>
      </section>
